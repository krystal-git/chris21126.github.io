export let helpCommand: Object = {
        ...
        settings: "tinker with in-built terminal settings to customize your command line experience.",
        clear: "clears all contents of terminal",
